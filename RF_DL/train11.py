...
if __name__ == "__main__":
    ...
    patchsize=11
    year=2022
    inputtag='sevenper'#'medianq75max'
    ...
    if inputtag=='medianq75max' or inputtag=='sevenper':
        inputtype=0
    ...
    for agu in [False]:
        for concat in [False]:
            for dropout in [0,0.2,0.3,0.5,0]:
                for l2 in [0,0.0001,0.001]:
                    ...
                    train(modeltag, depthwisecbrm=1,depthwisecorrd=0,ecabeforedense=0,cbrmbeforedense=1,concat=concat,dropout=dropout,l2=l2,agu=agu)
                #     train(modeltag, depthwisecbrm=0,depthwisecorrd=0,ecabeforedense=0,cbrmbeforedense=0,concat=concat,dropout=dropout,l2=l2,agu=agu)
