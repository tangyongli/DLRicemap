...
if __name__ == "__main__":
    ...
    mean=np.load(r"D:\ricemodify\datasetRF\202212median3maxpatchsize11\sample6265x4103_mean15.npy")
    std=np.load(r"D:\ricemodify\datasetRF\202212median3maxpatchsize11\sample6265x4103_std15.npy")
    ...
    for area in arealist:
        if area=='yuechi':
            ...
            startrow,startcol,endrow,endcol=2500,2500,4000,4000
        if area=='linshui':
        ...
        if area=='quxian':
            ...
            img_list = [file for file in os.listdir(img_dir) if file.endswith('.tif')]
            orgintif=os.path.join(img_dir,img_list[0])
            startrow,startcol,endrow,endcol=3000,0,5000,1000
            # "D:\ricemodify\runRFDL\train\patchsize11\2022\2022_medianq75max(10bands3index)_depthwisecenterpixelcatcenter"
        for modeltag in ['2024-02-13-15-06_12median3max(13)train6265val4103_agu1weghtTrue_depthwiseadd_nocatcbrmn0_cbrmlowhigh0__catlowhighTrue_drop0_l20'
