...
class PatchDataLoader:
    ...
    def generate_patches(self):
        ...
        work_dir=os.getcwd()
        data_dir=os.path.join(work_dir,f'limiteddataset\{self.year}pathsize{self.patchsize}')
        ...
        np.save(os.path.join(data_dir, f"samplesGEEvalue{imgtoarray.shape[0]}" ),imgtoarray)
        np.save(os.path.join(data_dir, f"samplesGEElabel{labeltoarray.shape[0]}" ),labeltoarray)
...
if  __name__ == "__main__":
    ...
    patchsize = 11
    year=2022
    sampledf=sample(r"D:\ricemodify\limiteddataset\yuechicentroid5classid6and13.csv")
