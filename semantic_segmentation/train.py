...
#         # time1=x[...,14:15]/365
#         # time2=2*(time1-0.5)
#         geo1=xtimegeo[...,0:1]/90
#         geo2=xtimegeo[...,1:2]/180
#         x=np.concatenate([xtrainbands,geo1,geo2],axis=-1)
#         x[np.isnan(x)]=0
#         ratio = np.sum(x== 0) / x.size #6376*49*121
#         print(f"值为0的比率: {ratio:.2%}") #值为-1的比率: 1.61%'
...
if __name__ == "__main__":
    ...
    savetrainxPath,savetrainyPath=r'D:\ricemodify\dataset\s1s2medianmaxmincloudmask\xmyyuan10915x1x11x11x19.npy',r'D:\ricemodify\dataset\s1s2medianmaxmincloudmask\ymyyuan10915x1x11x11x19.npy'#D:\ricemodify\dataset\withcloud\datasplit\xnomeanstd10915x2x11x11x15.npy',r'D:\ricemodify\dataset\withcloud\datasplit\ynomeanstd10915.npy'#D:\ricemodify\dataset\datasplit\xnomeanstd12473x2x33x33x15.npy',r'D:\ricemodify\dataset\datasplit\ynomeanstd12473.npy'
    dataloader=DataLoader(trainx=savetrainxPath, trainy=savetrainyPath, patch_size=11, include_index=False, bandposition=14, indexposition=17)
    # x=x[...,3:15]
    x,y=dataloader()
    print('x',x.shape)
    # random.shuffle(x)   
    ...
    from semantic_segmentation.model.models import  medianCnn2d#DualCnn2dGeotimeCbrm
    ...
    def metric_func( y_pred, y_true):
        ...
        return acc
    model=medianCnn2d(inputshape=(11,11,14),channelratio=8,bandswithindex=False,dropout=0.2,L2=0.002)
